...
export const en: Dictionary = {
  ...
  contactPage: {
    ...
    guidedNote: 'Six questions, nearly all of them taps. About 60 seconds, no obligation.',
    writeNote: 'Have a question that isn’t a quote request? Write to us here.',
