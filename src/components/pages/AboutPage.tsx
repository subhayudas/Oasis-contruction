...
export function AboutPage({ locale, crumbs }: { locale: Locale; crumbs: Crumb[] }) {
    ...
    <>
      <section className="u-wrap pt-8 pb-4 lg:pt-12">
        ...
        <div className="mt-10 grid items-start gap-10 lg:grid-cols-12 lg:gap-12">
          <div className="lg:col-span-7">
            ...
            <p className="u-accent text-teal-deep mt-3 text-[clamp(1.5rem,3vw,2.25rem)]">
              {t.aboutPage.accent}
            </p>
              ...
              items={[
                {
                  ...
                  value: area,
                  icon: <IconPin className="text-teal-deep h-4 w-4 shrink-0" />,
                },
                {
                  label: t.common.phone,
                  value: site.phone.display,
                  href: site.phone.href,
                  icon: <IconPhone className="text-teal-deep h-4 w-4 shrink-0" />,
                },
                {
                  label: t.common.hours,
                  value: hours,
                  icon: <IconClock className="text-teal-deep h-4 w-4 shrink-0" />,
                },
              ]}
            />
          </div>
          ...
          <figure className="lg:col-span-5">
            <div className="frame frame-keyline clip-notch shadow-[0_2px_4px_rgba(12,26,43,0.07),0_40px_60px_-46px_rgba(12,26,43,0.85)]">
              <Picture
                priority
      ...
      <section className="u-section">
        <div className="u-wrap grid gap-10 border-t border-[var(--line-strong)] pt-10 lg:grid-cols-12 lg:gap-14">
          <h2 className="u-h2 reveal text-[clamp(1.6rem,2.8vw,2.25rem)] lg:col-span-4">
        ...
        <div className="u-wrap">
          ...
          <ol className="mt-10 grid gap-px lg:grid-cols-3 lg:gap-x-8">
            {t.aboutPage.approach.map((item, index) => (
              ...
              >
                <span className="u-label text-bronze block text-[0.6875rem] tracking-[0.24em]">
        ...
        <div className="u-wrap grid gap-10 lg:grid-cols-12 lg:gap-14">
          <div className="reveal lg:col-span-4">
            ...
            <div className="s-plaque mt-8 px-5 py-4">
              <p className="u-label text-bronze relative z-10">{t.aboutPage.areaTitle}</p>
