...
/**
 * A simple full-height sheet: a focus trap, Escape to close, the scroll lock,
 * and nothing else. Every entry is a real link, so the panel is usable with a
      ...
      {open ? (
        <div className="fixed inset-0 z-50 lg:hidden">
          <button
            ...
            tabIndex={-1}
            onClick={close}
            className="bg-ink/45 absolute inset-0 h-full w-full cursor-default"
          />
          <div
            ref={panelRef}
            id={panelId}
            ...
            className="glass-panel absolute inset-y-0 right-0 flex w-full max-w-[24rem] flex-col overflow-y-auto shadow-[-24px_0_60px_-30px_rgba(12,26,43,0.65)]"
          >
